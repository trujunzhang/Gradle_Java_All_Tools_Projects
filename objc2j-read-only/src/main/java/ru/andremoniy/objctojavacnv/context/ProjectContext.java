...
public class ProjectContext extends AbstractContext {
    ...
    private void loadImports() throws IOException {
        ...
        File file = new File(getClass().getClassLoader().getResource("imports.csv").getFile());
    ...
    private void loadStaticFields() throws IOException {
        File file = new File(getClass().getClassLoader().getResource("staticFields.csv").getFile());
    ...
    private void loadEnums() throws IOException {
        ...
        File file = new File(classLoader.getResource("enums.csv").getFile());
